...
function Volume(x, y ,z) {
    ...
    // control parameter for the marching cube state
    const threshold = 0.2;
    const dilation = .5;
...
function createChunkMarchingCubes(offset, size) {
    ...
    for (let x = 0; x < Size-off; x++) {
        for (let y = 0; y < Size-off; y++) {
            for (let z = 0; z < Size-off; z++) {
                ...
                //    [offset[0]+x+1, offset[1]+y,    offset[2]+z],
                //    [offset[0]+x+1, offset[1]+y+1,  offset[2]+z],
                //    [offset[0]+x+1, offset[1]+y,    offset[2]+z+1],
                //    [offset[0]+x+1, offset[1]+y+1,  offset[2]+z+1],
                //    [offset[0]+x,   offset[1]+y+1,  offset[2]+z],
                //    [offset[0]+x,   offset[1]+y+1,  offset[2]+z+1],
                ...
                const configIndex = parseInt(binaryString, 2);
                ...
                TrianglesVertices.forEach(edge_index => {
                    ...
                    if (edge_index != -1) {
                        ...
                        geometryData.vertices.push(interpolated_point[0],interpolated_point[1],interpolated_point[2],);
